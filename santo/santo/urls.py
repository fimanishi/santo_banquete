...
urlpatterns = [
    ...
    url(r'^pedidos/filter/done/$', website.views_api.pedidos_filter_done, name="pedidos_filter_done"),
    ...
    url(r'^finalizar_pedido/finish/$', website.views_api.finalizar_pedido_finish, name="finalizar_pedido_finish"),
