...
class EstoqueSerializer (serializers.Serializer):
    ...
    total = serializers.DecimalField(required=False, decimal_places=2, localize=True, max_digits=7)
    estoque = serializers.DecimalField(required=False, decimal_places=3, localize=True, max_digits=7)
    unidade = serializers.CharField(max_length=20, required=False)
    por_unidade = serializers.DecimalField(required=False, decimal_places=3, localize=True, max_digits=7)
...
class ClienteSearchSerializer (serializers.Serializer):
    ...
    def validate(self, data):
        ...
        if not (data["nome"] or data["telefone"] or data["referencia"]):
            raise serializers.ValidationError(
